...
<div class="row" style="justify-content: center;">
    ...
    <form action="actionAlterar.php" method="post">
     <input type="hidden" class="form-control" id="id" name="id" value=<?php echo $row["id"]?>>  
        ...
        <div class="form-group">
            ...
            <input type="phone" class="form-control" id="telefone" name="telefone" value=<?php echo $row["telefone"]?>>
        </div>
        <div class="form-group form-check">
            <input type="checkbox" class="form-check-input" id="ativo" name="ativo" <?php echo $row["ativo"]=='S'?'checked':''?>>
